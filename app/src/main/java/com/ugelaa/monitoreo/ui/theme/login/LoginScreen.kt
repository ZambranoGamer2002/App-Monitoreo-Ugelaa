            ...
            Column(
                ...
                ElevatedCard(
                    ...
                    Column(
                        ...
                        Text(
                            text = "Sistema de Monitoreo y Seguimiento de Planes de Visita",
                            color = GrisTexto,
                            fontSize = 14.sp,
                                    ...
                                    try {
                                        ...
                                        if (response.isSuccessful && response.body() != null) {
                                            ...
                                            if (loginResponse.success) {
                                                ...
                                                val dniReal = loginResponse.usuario.dni.orEmpty()
                                                ...
                                                navController.navigate(
                                                    "home_monitoreo/$nombreReal/$nicknameReal"
                                                ) {
                                                ...
                                                errorMessage = "API: ${loginResponse.message}"
                                            }
